...
int main(void) {
    ...
    /* White border around the whole frame */
    ...
    /* A grid of colored filled rectangles */
    int cols = 8, rows = 6;
    int cw = XD_WIDTH / cols;
    int ch = XD_HEIGHT / rows;
    xd_color_t palette[] = {
        XD_RED, XD_GREEN, XD_BLUE,
        XD_YELLOW, XD_CYAN, XD_MAGENTA,
        XD_WHITE, XD_COLOR(128, 64, 0)
    };
    ...
    /* A few filled rectangles in the center */
    ...
    /* Flush: server writes PPM to /tmp/xd_frame_0000.ppm */
    xd_flush();
